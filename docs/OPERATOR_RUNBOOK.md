...
node scripts/summarize-go-live-closure.js --bundle outputs/go-live-bundle/<timestamp>  # final closure board, no pending
node scripts/validate-go-live-closure-status.js outputs/go-live-closure-status/<timestamp>  # final closure validator, no pending
set -o pipefail
