...
node scripts/verify-100-readiness.js --allow-pending       # final verifier structure check
node scripts/verify-100-readiness.js                       # must PASS before declaring 100%
...
node scripts/create-go-live-bundle.js --evidence outputs/phase9-evidence/<timestamp> --uat-evidence outputs/uat-evidence/<timestamp>  # final bundle, no pending
