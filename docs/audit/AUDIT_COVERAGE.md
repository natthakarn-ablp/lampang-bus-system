...
> **Historical snapshot (ติดป้าย 5 ก.ย. 2569):** ขอบเขตการตรวจในเอกสารนี้ผูกกับ commit `9a64efc` (27 ส.ค. 2569) ไม่ใช่ HEAD ปัจจุบัน
> สถานะจริงล่าสุด: `docs/project-closure/handoff-2026-09-05.md` · เหตุผลที่ติดป้าย: `docs/project-closure/current-status-2026-09-04.md` §5 (#8)
