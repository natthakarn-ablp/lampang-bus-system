...
**ผลที่วัดได้จากข้อมูลจริงหลังขึ้นระบบ (28 ส.ค. 2569):** มีบัญชีครูสายชั้นที่ใช้งานอยู่
21 บัญชี ทุกบัญชีเคยเห็นนักเรียนทั้งโรงเรียนในรายงาน ตอนนี้เห็นเฉพาะสายชั้นตัวเอง

ที่สำคัญกว่านั้น การเปลี่ยนการจับคู่ระดับชั้นเป็นแบบยืดหยุ่นไม่ใช่เรื่องเชิงทฤษฎี —
**โรงเรียนอนุบาลลำปางเขลางค์รัตน์อนุสรณ์ (SCH0001, นักเรียน 550 คน, รถ 137 คัน)
บันทึกระดับชั้นเป็นรูปแบบยาวทั้งหมด** (`ประถมศึกษาปีที่ 5` ไม่ใช่ `ป.5`) การจับคู่
แบบตรงตัวจึงคืนค่า 0 หรือ 1 สำหรับครูทั้ง 9 บัญชีของโรงเรียนนี้ ผลคือหน้าที่เคยใช้
`s.grade = ?` — ใบลา, ตำแหน่งรถ, คำขอแก้ไขรายชื่อ, และรายชื่อที่ยังไม่เช็ก — **แสดงผลว่าง
มาโดยตลอด** ซึ่งอ่านได้ว่า "ไม่มีใครลา" หรือ "ไม่มีรถ" แทนที่จะเป็น "ตัวกรองไม่ตรงกับใครเลย"
ทั้งระบบมีนักเรียน 929 คนที่ระดับชั้นถูกบันทึกเป็นรูปแบบอื่นนอกเหนือจากรูปแบบย่อ

นี่เป็นข้อบกพร่องที่ทำงานอยู่จริงกับผู้ใช้จริง ไม่ใช่ความเสี่ยงในอนาคต และไม่ได้อยู่ใน
ขอบเขตของ AUD-004 เดิม — พบเพราะการไล่ตรวจทุกเส้นทางแทนที่จะแก้เฉพาะจุดที่รายงานชี้
