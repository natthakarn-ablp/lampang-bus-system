...
> เมนู **จุดเตือนภัย (Geofences)** และ **การเบี่ยงเส้นทาง** ยังไม่เปิดใช้งานบนระบบจริง จึงถูกซ่อนจากแถบเมนู
> ส่วน **เรื่องที่ต้องมีส่วนร่วม** เปิดใช้งานแล้วตั้งแต่ 7 กันยายน 2569 และแสดงเป็นรายการแรกของแถบเมนู
...
3. สร้างผู้ใช้ใหม่โดยกรอก "ชื่อผู้ใช้", "รหัสผ่าน" (เป็นรหัสชั่วคราว ระบบจะบังคับให้ผู้ใช้เปลี่ยนเมื่อเข้าใช้งานครั้งแรก), "บทบาท", "หน่วยงาน" (เฉพาะบทบาทโรงเรียน สังกัด และจังหวัด), "ระดับชั้น (สำหรับครูประจำสายชั้น)" (เฉพาะบทบาทโรงเรียน เมื่อต้องการสร้างบัญชีครูประจำสายชั้น) และ "ชื่อแสดง" (ไม่บังคับ)
   ...
   - ข้อความบนหน้าจอเคยเขียนว่า "อย่างน้อย 6 ตัวอักษร" ซึ่งไม่ตรงกับที่ระบบบังคับ **แก้แล้วเมื่อ 8 กันยายน 2569** ตอนนี้ทุกช่องเขียนตรงกันว่าอย่างน้อย 8 ตัวอักษร
