...
| ดูรายงานที่อนุญาต | ทำได้ — แต่ดูหมายเหตุด้านล่าง |
| Import นักเรียน | ไม่ควรใช้/ถูกจำกัด |
| จัดการบัญชีครู | ทำไม่ได้ |
| Audit log โรงเรียน | ถูกบล็อก |
| Bulk vehicles | ถูกบล็อก |

> **หมายเหตุเรื่องหน้ารายงาน (ตรวจพบ 27 ส.ค. 2569)**
>
> การจำกัดตาม `grade_scope` มีผลกับทุกหน้าในกลุ่มโรงเรียน **ยกเว้นหน้ารายงาน**
> ซึ่งขณะนี้แสดงและส่งออกข้อมูลนักเรียนทั้งโรงเรียน ไม่ได้จำกัดเฉพาะระดับชั้น
> ที่ได้รับมอบหมาย เรื่องนี้อยู่ระหว่างการพิจารณาของผู้บริหารว่ากติกาที่ถูกต้อง
> ควรเป็นอย่างไร ระหว่างนี้โปรดใช้ความระมัดระวังในการส่งออกไฟล์รายงาน
> เพราะไฟล์จะมีชื่อนักเรียนทั้งโรงเรียน ไม่ใช่เฉพาะชั้นของท่าน
