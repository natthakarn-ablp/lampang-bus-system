...
> เมนู "เรื่องที่ต้องมีส่วนร่วม" เปิดใช้งานแล้วตั้งแต่ 7 กันยายน 2569 และแสดงในเมนู ขนส่งจะเห็นเฉพาะเรื่องที่ผู้ยื่น**เลือกขอบเขตเป็น "ขนส่ง"** ตอนยื่น ไม่ได้แบ่งตามว่าเนื้อหาเกี่ยวกับการตรวจสภาพรถหรือไม่ เรื่องเกี่ยวกับรถที่ยื่นในขอบเขตโรงเรียนจะไม่ปรากฏให้ขนส่งเห็น
