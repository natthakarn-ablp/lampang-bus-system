...
**อัปเดต 5 ก.ย. 2569:** ทำครบทั้ง 31 รายการแล้ว — 13 ฉบับติดป้าย `Historical snapshot (ติดป้าย 5 ก.ย. 2569)` ใต้หัวเรื่อง, 5 ฉบับที่ยังใช้งาน (#10–#16) แก้บรรทัดในที่พร้อมระบุว่าแก้ตามข้อไหน, และ #20/#31 แก้ปลายทางของ banner เดิมให้ชี้มาที่ `handoff-2026-09-05.md` กับเอกสารนี้ เทสต์ `backend/tests/historicalDocsBanner.unit.test.js` กันไม่ให้ป้ายหาย
