...
> **Historical snapshot (ติดป้าย 6 ก.ย. 2569):** ร่าง Markdown ฉบับ 2026-06-24 — ไม่ใช่ฉบับที่เผยแพร่ และหลายจุดไม่ตรงกับระบบจริง (เมนูและปุ่มเปลี่ยนไปหลายจุดหลังจากนั้น และบางข้อความคลาดเคลื่อนมาตั้งแต่ต้น เช่น รหัสผ่านชั่วคราวที่ผู้ดูแลระบบตั้งให้ต้องยาวอย่างน้อย 8 ตัวอักษร ไม่ใช่ 6) ห้ามใช้อบรมหรืออ้างอิง
> ฉบับที่ใช้จริง: `docs/manual-html/user-guide-admin.html` (https://schoolbuslampang.com/manual/user-guide-admin.html) · ชุดอบรม: `docs/manual-training-2026-08/README.md`
...
- ขณะ admin สร้าง/รีเซ็ตให้ ต้องตั้งรหัสชั่วคราว **อย่างน้อย 8 ตัวอักษร** (ไม่เกิน 128) ห้ามตรงกับชื่อผู้ใช้ ห้ามเดาง่าย เช่น 12345678/password — และผู้ใช้จะถูกบังคับตั้งรหัสใหม่อีกครั้งตอนล็อกอินครั้งถัดไป
...
2. กรอก **ชื่อผู้ใช้** และ **รหัสผ่าน** (ชั่วคราว, อย่างน้อย 8 ตัวอักษร — ห้ามตรงกับชื่อผู้ใช้/ห้ามเดาง่าย)
...
2. กรอกรหัสใหม่ (ชั่วคราว) อย่างน้อย **8 ตัวอักษร** (ห้ามตรงกับชื่อผู้ใช้ ห้ามเดาง่าย)
...
| อาการ | วิธีแก้ |
|---|---|
| สร้าง/รีเซ็ตผู้ใช้แล้วขึ้น "รหัสผ่านต้องมีอย่างน้อย 8 ตัวอักษร" | ระบบบังคับรหัส ≥8 ตัวทุกครั้งที่ตั้งรหัสให้ผู้ใช้คนอื่น (รวมรหัสชั่วคราว) ห้ามตรงกับชื่อผู้ใช้/ห้ามเดาง่าย — ตั้งรหัสให้ยาวพอแล้วลองใหม่ (ผู้ใช้ยังถูกบังคับเปลี่ยนเองตอน login ครั้งถัดไป) หมายเหตุ: ข้อความช่วยใต้ช่องกรอกบนหน้าจอยังเขียนว่า "อย่างน้อย 6 ตัวอักษร" (ยังไม่ได้แก้) และถ้าพิมพ์สั้นกว่า 6 ตัวในกล่อง "รีเซ็ตรหัส" จะขึ้นเตือน 6 ตัวก่อน — ให้ยึด 8 ตัวเป็นเกณฑ์จริง |
