...
> **Historical snapshot (ติดป้าย 6 ก.ย. 2569):** ร่าง Markdown ฉบับ 2026-06-24 — ไม่ใช่ฉบับที่เผยแพร่และไม่ตรงกับระบบปัจจุบัน (ขาดงาน "ขึ้นทะเบียนรถ" และ "รายชื่อเด็กในรถ" ซึ่งเป็นงานหลักของคนขับในตอนนี้ ส่วนแท็บ "คำขอ" ไม่มีอยู่ในระบบ และเมนู "เลือกรถและเริ่มรอบ" ยังไม่เปิดใช้งานจึงไม่ปรากฏบนหน้าจอ) ห้ามใช้อบรมหรืออ้างอิง
> ฉบับที่ใช้จริง: `docs/manual-html/user-guide-driver.html` (https://schoolbuslampang.com/manual/) · ชุดอบรม: `docs/manual-training-2026-08/README.md`
...
3. กรอก **รหัสผ่าน** ที่โรงเรียนหรือผู้ดูแลบัญชีแจ้งให้ — รหัสตั้งต้นใช้ได้ครั้งแรกเท่านั้น แล้วระบบจะให้ตั้งรหัสใหม่
4. กด **เข้าสู่ระบบ**
