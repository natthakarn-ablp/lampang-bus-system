...
> **Historical snapshot (ติดป้าย 6 ก.ย. 2569):** ร่าง Markdown ฉบับ 2026-08-14 — ไม่ใช่ฉบับที่เผยแพร่ และหลายจุดไม่ตรงกับระบบจริงในวันนี้ (ชื่อช่องเข้าสู่ระบบ ตัวกรองหน้าข้อมูลนักเรียน ตัวกรองหน้ารายงาน และขั้นตอนหน้าสถานะวันนี้) ห้ามใช้อบรมหรืออ้างอิง
> ฉบับที่ใช้จริง: `docs/manual-html/user-guide-province.html` (https://schoolbuslampang.com/manual/user-guide-province.html) · ชุดอบรม: `docs/manual-training-2026-08/README.md`

> ระบบรถรับส่งนักเรียนจังหวัดลำปาง — https://schoolbuslampang.com
> เวอร์ชัน Phase 10.13C • อัปเดต 2026-08-14 (เลิกใช้แล้ว)
...
- บัญชีที่ย้ายมาจากระบบเดิมบางบัญชีมีรหัสผ่านตั้งต้นที่สั้นกว่าเกณฑ์ปัจจุบัน (8 ตัวอักษร) — ถ้ารหัสของท่านยังสั้น ให้เปลี่ยนเองทันทีที่เมนูบัญชี (มุมขวาบน) → "เปลี่ยนรหัสผ่าน" เอกสารนี้เผยแพร่สาธารณะ จึงไม่พิมพ์รหัสตั้งต้นไว้
