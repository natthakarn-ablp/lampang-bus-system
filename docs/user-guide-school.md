...
> **Historical snapshot (ติดป้าย 6 ก.ย. 2569):** ร่าง Markdown ฉบับ 24 มิ.ย. 2569 — ไม่ใช่ฉบับที่เผยแพร่และไม่ตรงกับระบบปัจจุบัน (เมนู ปุ่ม และกติกาสิทธิ์ของบัญชีครูประจำสายชั้นเปลี่ยนหลัง 28 ส.ค. 2569) ห้ามใช้อบรมหรืออ้างอิง
> ฉบับที่ใช้จริง: `docs/manual-html/user-guide-school.html` (https://schoolbuslampang.com/manual/) · ชุดอบรม: `docs/manual-training-2026-08/README.md`
