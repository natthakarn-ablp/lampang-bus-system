...
> **Historical snapshot (ติดป้าย 6 กันยายน 2569):** ร่าง Markdown ฉบับ 2026-06-24 — ไม่ใช่ฉบับที่เผยแพร่ และไม่ตรงกับระบบปัจจุบัน (ยังไม่มีหัวข้อ "ลงทะเบียนรายชื่อเด็กในรถ" ซึ่งเปิดใช้งานจริงแล้ว และเนื้อหาส่วนอื่นถูกแก้ให้ตรงกับระบบจริงในฉบับเผยแพร่เมื่อ 28 ส.ค. 2569) ห้ามใช้อบรมหรืออ้างอิง
> ฉบับที่ใช้จริง: `docs/manual-html/user-guide-transport.html` (https://schoolbuslampang.com/manual/user-guide-transport.html) · ชุดอบรม: `docs/manual-training-2026-08/07-transport.md`
...
- บัญชีที่นำเข้าจากระบบเดิม (migrate) ถ้าไม่ได้ระบุรหัส → ใช้รหัสตั้งต้นที่ผู้ดูแลบัญชีแจ้ง (เอกสารนี้เผยแพร่สาธารณะ จึงไม่พิมพ์รหัสไว้)
