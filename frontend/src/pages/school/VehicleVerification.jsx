...
const CLOSED_STATUSES = new Set(['CANCELLED', 'FAILED', 'PASSED', 'EXPIRED', 'SUPERSEDED']);
    ...
    <div className="mx-auto max-w-6xl space-y-5 p-3 sm:p-6">
      <div className="print:hidden">
        <CommandHero
          ...
          description="ออกใบส่งตรวจออนไลน์จากข้อมูลรถที่โรงเรียนใช้งาน แม้หลายโรงเรียนใช้รถคันเดียวกันก็รวมเป็นเอกสารชุดเดียวให้ขนส่งตรวจได้"
          icon={ShieldCheck}
          meta={heroMeta}
          actions={(
            <button
